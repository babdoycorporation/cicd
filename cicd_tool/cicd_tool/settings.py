"""
Django settings for cicd_tool project.
"""
...
MIDDLEWARE = [
    ...
    'django.middleware.csrf.CsrfViewMiddleware',   # ← re-enabled; API views use @csrf_exempt
...
DEFAULT_FROM_EMAIL = 'RockerCI <noreply@rockerci.local>'
...
LOGGING = {
    ...
    'loggers': {
        ...
        'pipeline': {'handlers': ['console', 'file'], 'level': 'DEBUG', 'propagate': False},
        'gitmgmt': {'handlers': ['console', 'file'], 'level': 'DEBUG', 'propagate': False},
    },
}
