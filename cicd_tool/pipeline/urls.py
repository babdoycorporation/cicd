...
urlpatterns = [
    ...
    path('pipeline/<int:pipeline_id>/run/', views.run_pipeline, name='run_pipeline'),
    path('pipeline/run/<uuid:run_id>/', views.pipeline_run_detail, name='pipeline_run_detail'),
